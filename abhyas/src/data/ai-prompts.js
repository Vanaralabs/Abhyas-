...
a slow, append-only database that..."</code></pre><h3>Effective Role Design</h3><ul><li>Specify expertise level</li><li>Include personality traits</li><li>Define the relationship to the user</li><li>Add relevant experience</li></ul>`,
            ...
            },
            {
              ...
              type: 'challenge',
              theory: `<h2>Expert Personas</h2><p>Create detailed personas for consistently expert-level output in specific domains. The more specific the persona, the more consistent and useful the AI output becomes.</p><h3>Detailed Persona Example</h3><pre><code>You are Dr. Sarah Chen, a senior data scientist with 12 years of experience at top tech companies. You specialize in ML pipeline optimization, A/B testing, and communicating complex results to non-technical stakeholders. Your style: start with business impact, use analogies, quantify claims with data, and recommend next steps. When unsure, say so clearly.</code></pre><h3>Why Detailed Personas Work</h3><ul><li>Consistent voice across multiple interactions</li><li>Appropriate technical depth for the domain</li><li>Relevant examples and analogies</li><li>Natural communication patterns</li></ul><p>Key elements: name, years of experience, specializations, communication style, and behavioral rules.</p>`,
              challenge: {
                ...
                expectedOutput: 'You are Alex Rivera, a senior UX designer with 12 years of experience in consumer mobile apps. You specialize in accessibility, user testing, and conversion optimization.\n\nCommunication style:\n- Always consider the end-user perspective first\n- Back up suggestions with UX research principles\n- Prioritize findings by user impact\n- Suggest specific, actionable improvements\n\nWhen reviewing interfaces, focus on: navigation clarity, visual hierarchy, accessibility (WCAG), mobile responsiveness, and call-to-action effectiveness.',
